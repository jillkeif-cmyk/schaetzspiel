...
- Casino-XP (vip.xpFor): Grundwert (≤ 400 nach Einsatz) + Zuschlag base·(0,3 + 1,5·(√m − √5)) ab 5× + 1 % des Reingewinns ab 5×, max. 300.000 je Runde (vor Trank/Hot Time). 50.000 / 10 Mio.: 106.646 XP (vorher 400). Ø je Dreh bei 1.000 Einsatz 79 (vorher 68), bei 50.000: 717 (vorher 376).
