...
- Trophäen-Vitrine (lib/trophies.js LIB, Setting trophies): nur beim Admin (profileExtras), gold umrandet über der Vitrine, antippbar (zoomImg). Bearbeiten nur Admin (/api/admin/trophies). Bilder in public/trophies/ (karambit, ak47 = noch Platzhalter, echte Bilder vom Nutzer folgen).
