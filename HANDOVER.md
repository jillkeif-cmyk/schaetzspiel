...
- Tränke (lib/potions.js): pot_xp2/4, pot_cxp2/4, pot_pxp2/4 als versteckte PACKS-Einträge (potion:true), im Inventar „🧪 Tränke“. /api/potion/use aktiviert (1 pro XP-Art), 60 Min App-Zeit: Uhr läuft nur, wenn game.online (Tick 15 s), Stand in users.pot_active. Wirkung: game.js Level-XP und Pass-XP, casinoStat und Poker Casino-XP. Nicht verkaufbar, nicht öffnbar. Bilder /tcg/pot_xp|cxp|pxp.webp, ×2/×4 per CSS.
