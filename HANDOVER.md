...
- Shop-Steuerung Displays + Tränke (display_cfg): im Verkauf, Preis, Bestand, Ausverkauft, Hinweis. Tränke standardmäßig aus und ohne Preis; im Shop eigener Bereich „🧪 Tränke“, nur wenn an und Preis > 0.
