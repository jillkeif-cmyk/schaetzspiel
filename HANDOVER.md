...
- Booster „Nicht im Verkauf“ (offsale in shop_cfg) blendet ihn im Shop aus; Displays auch „Ausverkauft“ (soldout in display_cfg). Displays umwandeln: 25 % des Shop-Preises (/api/tcg/meltdisplay, Reiter Umwandeln). Startseite: „Karten, Booster & Börse“ direkt nach den Matches; Börse-Reiter grün hervorgehoben.
