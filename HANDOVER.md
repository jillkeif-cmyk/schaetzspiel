...
- Buch der Gruft Bücher-Szene: berechnete Animation public/cr/book_fly.webp (4 s, einmal abgespielt, Render-Skript /tmp/fly/render.py: Gang mit Fackeln → grüne Kammer → Altar mit Grimoire → Blitz). Ausdehnen: Walze mit durchgehendem Goldrahmen (.cr-col), Symbol bewegt sich (crsym: Zoom, Drehung, Glanz), andere Walzen sehr dunkel.
