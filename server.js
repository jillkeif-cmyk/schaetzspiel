...
// Code einlösen
let homeCfg = { newsCard: true, ui2Live: false, promo: { on: false, game: 'crypt', text: '' } }; // ui2Live: neues Design für alle // Startseite: Update-Karte und Automaten-Werbung (Admin-Menü)
...
app.post('/api/admin/home', async (req, res) => { // Startseite: Update-Karte an/aus, Automaten-Werbung (Spiel, Text, an/aus)
  ...
  if ('ui2Live' in b) { homeCfg.ui2Live = !!b.ui2Live; console.log(`Neues Design ${homeCfg.ui2Live ? 'für ALLE live' : 'nur zum Testen'} durch ${u.name}`); }
