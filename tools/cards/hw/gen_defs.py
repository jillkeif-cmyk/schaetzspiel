...
B = [
 ...
 ('gn_b14','Lich-König','Tod','an undead lich king with a glowing crown and a staff with a skull'),
 ('gn_b15','Geisterlaterne','Geister','a floating old lantern with a trapped teal spirit inside'),
 ('gn_b16','Knochengolem','Tod','a golem made of bones and skulls with glowing green eyes'),
 ...
 ('gn_b20','Grabräuber-Skelett','Tod','a sneaky skeleton thief with a sack of gold in a crypt'),
 ...
 ('gn_b28','Totengräber','Tod','a tall grim gravedigger with a skull-topped shovel in the rain'),
 ...
 ('gn_b33','Totenmaske','Tod','a floating ornate death mask with glowing green eyes'),
 ...
 ('gn_b37','Knochenschlange','Tod','a giant serpent made of vertebrae coiling around a tomb'),
 ('gn_b38','Kerzengeist','Geister','a small ghost made of candle smoke above a candelabra'),
 ...
 ('gn_b42','Gespensterturm','Geister','a crooked haunted tower with ghosts spiraling around it'),
 ('gn_b43','Schädelkrähe','Tod','a crow with a skull face perched on a withered branch'),
 ...
 ('gn_b46','Knochenkoloss','Tod','a colossal giant made of thousands of bones towering over a city'),
 ...
 ('gn_b50','Totenfürst','Tod','the lord of the dead on a throne of bones with a flaming crown'),
]
