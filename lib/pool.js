...
module.exports = function createPool(store) {
  ...
  function stats(seenByMe) {
    ...
    return {
      loaded, mode: fill.mode, effort: fill.effort, batchStatus: fill.batch ? (fill.batchStatus || 'abgeschickt') : '', running: fill.running, auto: fill.auto, target: fill.target, inFlight: fill.inFlight, made: fill.made, rejected: fill.rejected,
