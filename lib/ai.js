...
function requestBody(prompt, effort) {
  ...
  if (effort) b.output_config = { effort };
  return b;
}
...
module.exports = { enabled, generate, validate, leaks, usage, batchSubmit, batchPoll, batchResults, hasKey: () => !!KEY, buildPrompt, requestBody, seedList };
