...
[{"t":"est","q":"...","a":123.4,"unit":"m","cat":"Bauwerke","s":"..."},{"t":"mc","q":"...","o":["A","B","C","D"],"c":2,"cat":"Kultur","s":"..."}]`;
  ...
  try {
    ...
    if (data.usage) { usage.calls++; usage.input += data.usage.input_tokens || 0; usage.output += data.usage.output_tokens || 0; }
...
module.exports = { enabled, generate, validate, leaks, usage };
