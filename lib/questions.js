...
// BookTok
Y('In welchem Jahr erschien „Der Herr der Ringe: Die Gefährten“ im Original?', 1954, 'BookTok');
Y('In welchem Jahr erschien der erste Harry-Potter-Band im Original?', 1997, 'BookTok');
...
Y('In welchem Jahr erschien „Stolz und Vorurteil“ von Jane Austen?', 1813, 'BookTok');
Y('In welchem Jahr erschien „1984“ von George Orwell?', 1949, 'BookTok');
E('Wie viele Bände hat die Harry-Potter-Reihe?', 7, 'Bände', 'BookTok');
E('Wie viele Bände hat die Reihe „Die Tribute von Panem“ ohne Vorgeschichten?', 3, 'Bände', 'BookTok');
E('Wie viele Bände umfasst „Der Herr der Ringe“?', 3, 'Bände', 'BookTok');
E('Wie viele Bücher umfasst die Twilight-Hauptreihe?', 4, 'Bücher', 'BookTok');
E('Wie viele Kapitel hat „Der kleine Prinz“?', 27, 'Kapitel', 'BookTok');
...
M('Wer schrieb „Die Bibliothek der Träume“ („Die Mitternachtsbibliothek“)?', ['Matt Haig', 'Fredrik Backman', 'Mitch Albom', 'Paulo Coelho'], 'BookTok');
M('Wer schrieb die Reihe „Der Herr der Ringe“?', ['J. R. R. Tolkien', 'C. S. Lewis', 'George R. R. Martin', 'Terry Pratchett'], 'BookTok');
M('Wer schrieb „Das Lied von Eis und Feuer“?', ['George R. R. Martin', 'Brandon Sanderson', 'Patrick Rothfuss', 'Joe Abercrombie'], 'BookTok');
M('Wer schrieb „Der Alchimist“?', ['Paulo Coelho', 'Hermann Hesse', 'Gabriel García Márquez', 'Antoine de Saint-Exupéry'], 'BookTok');
M('Wie heißt der erste Band der Reihe „Shatter Me“ auf Deutsch?', ['Ich fürchte mich nicht', 'Träume so blau', 'Nur ein Wort', 'Das Feuer in mir'], 'BookTok');
M('In welchem Verlagsformat wurde „Fourth Wing“ besonders populär auf TikTok?', ['Fantasy-Romantasy', 'Krimi', 'Sachbuch', 'Biografie'], 'BookTok');
