...
let CAP_K = [0, 1, 2, 3, 4, 6, 9, 12], CAP_W = [4450, 645, 490, 275, 155, 82, 31, 10]; // Kappe selbst ist immer Narr; weitere Felder: oft keins, selten bis 12. Auszahlung ≈ 95 %
...
function capShake(g, rnd = randomInt, forceExtra = null) { // Kappen werden Narren, dazu zufällig weitere Felder
  ...
  const turned = [];
  for (const [c, r] of caps) g[c][r] = 'W'; // die Kappe selbst zählt immer als Narr (wie im Original)
