...
const DAYS = [ // deutlich höher als früher (passend zu den größeren Gewinnen im Casino)
  { dia: 5000 },
  { dia: 7500 },
  { dia: 7500, pack: 'premium' },
  { dia: 10000 },
  { dia: 10000, pack: 'ghost' },
  { dia: 15000 },
  { dia: 25000, pack: 'gn', title: 'Siebenfach' },
];
const DIA = DAYS.map((d) => d.dia);
const TASKS = [
  { key: 'play', text: 'Spiele 1 Match zu Ende', need: 1, dia: 2000, stat: 'matches' },
  { key: 'win', text: 'Gewinne 1 Match', need: 1, dia: 3200, stat: 'wins' },
  { key: 'cards', text: 'Öffne 1 Booster', need: 1, dia: 2400, stat: 'packs_opened' },
  { key: 'casino', text: 'Spiele 3 Casino-Runden', need: 3, dia: 2000, stat: 'casino_rounds' },
  { key: 'exact', text: 'Lande 1 Punktlandung', need: 1, dia: 4800, stat: 'exact' },
  { key: 'answer', text: 'Beantworte 20 Fragen', need: 20, dia: 2000, stat: 'answered' },
  { key: 'melt', text: 'Wandle 1 doppelte Karte um', need: 1, dia: 1600, stat: 'melted' },
];
