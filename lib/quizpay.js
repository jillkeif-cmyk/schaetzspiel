...
module.exports = {
  ...
  amount: ({ solo, win, score, need: nd }) => {
    const c = cfg, full = solo ? c.solo : c.win, need = nd || (solo ? c.soloPts : c.pts); // Solo: volle Diamanten ab der Sieggrenze der gewählten Fragenzahl
