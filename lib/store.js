...
const TEXT_KEYS = ['tag', 'tag_color', 'emblem', 'title', 'codes', 'role', 'unlocks', 'frame', 'seen_items', 'daily_day', 'casino_day', 'cash_prev_day', 'cash_claimed', 'wheel_day', 'casino_theme', 'first_game_day', 'news_claimed', 'showcase'];
const rank = (a, b) => b.prestige - a.prestige || b.xp - a.xp || b.wins - a.wins;

function memoryStore() {
  const seen = new Map(); // Spieler -> gesehene Fragen
  const trades = [], tickets = [], gifts = [];
