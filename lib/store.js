...
const NUM_KEYS = ['pass_cxp', 'casino_ban', 'wheel_bonus', 'pass_xp', 'pass_prem', 'pass_bank', 'matches', 'wins', 'answered', 'exact', 'close', 'mc_right', 'mc_total', 'points', 'dev_sum', 'dev_n', 'xp', 'prestige', 'best_score', 'streak', 'best_streak', 'av', 'rank_points', 'pres_shown', 'last_seen', 'diamonds', 'casino_xp', 'casino_rounds', 'casino_wins', 'casino_best', 'casino_net', 'daily_streak', 'daily_base', 'packs_opened', 'melted', 'casino_day_net', 'cash_prev_net', 'wheel_used', 'poker_hands', 'poker_wins', 'poker_best', 'poker_allin_wins', 'play_minutes', 'poker_minutes', 'peak_cards_total', 'peak_cards_rare', 'peak_cards_ext', 'peak_toon', 'peak_collect', 'slot_spins', 'slot_full', 'slot_best'];
const TEXT_KEYS = ['pass_cc', 'pot_active', 'pass_season', 'pass_cf', 'pass_cp', 'pass_wk', 'pass_wdone', 'tag', 'tag_color', 'emblem', 'title', 'codes', 'role', 'unlocks', 'frame', 'seen_items', 'daily_day', 'casino_day', 'cash_prev_day', 'cash_claimed', 'wheel_day', 'casino_theme', 'first_game_day', 'news_claimed', 'showcase', 'showcase_g', 'chal_paid'];
