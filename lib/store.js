...
function pgStore(url) {
  ...
  return {
    ...
    async giftAdd(g) { return one('INSERT INTO gifts(user_id,diamonds,pack,n,reason) VALUES($1,$2,$3,$4,$5) RETURNING *', [g.user_id, g.diamonds || 0, g.pack || null, g.n || 0, g.reason || '']); },
