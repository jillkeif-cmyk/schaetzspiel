...
module.exports = function attach(io, store) {
  ...
  const PAGE_TXT = { home: 'im Hauptmenü', casino: 'im Casino', 'casino:roulette': 'spielt Roulette', 'casino:bj': 'spielt Blackjack', 'casino:vip': 'am Glücksrad', 'casino:jester': 'spielt Narrenkappe', 'casino:rewards': 'schaut Casino-Belohnungen', 'casino:crank': 'schaut die Casino-Rangliste', 'casino:tables': 'sucht einen Blackjack-Tisch', 'casino:poker': 'schaut beim Poker zu', 'casino:triple': 'bei Triple Crown', 'casino:watch': 'schaut im Casino zu', cards: 'bei Karten & Booster', ranks: 'schaut die Ranglisten', profile: 'bearbeitet sein Profil' };
