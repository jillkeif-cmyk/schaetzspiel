...
const FRAMES = [
  { id: 'fsup', name: 'Tüftelwerk', need: 'Nur als Dankeschön vom Entwickler-Team (Support)', event: true, cond: () => false, anim: 'tuefte' }, // dreht nicht: der Hamster bleibt oben
  { id: 'fp1', name: 'Geisternacht', need: 'Kronen-Pass Geisternacht: Premium-Stufe 20', event: true, cond: () => false, anim: 'spin' },
  ...
  { id: 'FK1', name: 'Kartenkranz',   need: 'Sammle alle Karten: jede Karte in jeder Fassung, Doppelte zählen nicht', cond: (u) => (u.collect_unique || 0) >= (u.collect_all || 295), anim: 'crown' },
