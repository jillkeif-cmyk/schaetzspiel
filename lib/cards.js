...
const EMBLEMS = [
  // Casino-VIP-Stufen als Embleme: frei, sobald die Stufe erreicht ist
  { id: 'VIP0', name: 'VIP Bronze', need: 'Erreiche im Casino die VIP-Stufe Bronze', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 0 },
  { id: 'VIP1', name: 'VIP Silber', need: 'Erreiche im Casino die VIP-Stufe Silber', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 3000 },
  { id: 'VIP2', name: 'VIP Gold', need: 'Erreiche im Casino die VIP-Stufe Gold', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 10000 },
  { id: 'VIP3', name: 'VIP Platin', need: 'Erreiche im Casino die VIP-Stufe Platin', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 25000 },
  { id: 'VIP4', name: 'VIP Diamant', need: 'Erreiche im Casino die VIP-Stufe Diamant', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 50000 },
  { id: 'VIP5', name: 'VIP Black Card', need: 'Erreiche im Casino die VIP-Stufe Black Card', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 90000 },
  { id: 'VIP6', name: 'VIP Obsidianherz', need: 'Erreiche im Casino die VIP-Stufe Obsidianherz', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 250000 },
  { id: 'VIP7', name: 'VIP Purpurflamme', need: 'Erreiche im Casino die VIP-Stufe Purpurflamme', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 750000 },
  { id: 'VIP8', name: 'VIP Geisterhand', need: 'Erreiche im Casino die VIP-Stufe Geisterhand', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 2000000 },
  { id: 'VIP9', name: 'VIP Schattenkrone', need: 'Erreiche im Casino die VIP-Stufe Schattenkrone', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 5000000 },
  { id: 'VIP10', name: 'VIP Totenkönig', need: 'Erreiche im Casino die VIP-Stufe Totenkönig', casino: true, cond: (u) => (Number(u.casino_xp) || 0) >= 10000000 },
  ...
  { id: 'ES1', name: 'Walzenkrone',    need: 'Hol 10 Vollbilder bei Triple Crown', cond: (u) => (u.slot_full || 0) >= 10, anim: 'video' },
  { id: 'ES2', name: 'Goldener Chip',  need: 'Gewinne 50.000 Diamanten in einem Triple-Crown-Spiel', cond: (u) => (u.slot_best || 0) >= 50000, anim: 'video' },
  { id: 'EK1', name: 'Sammelmappe',       need: 'Sammle 150 verschiedene Karten, jede Fassung zählt einmal', cond: (u) => (u.collect_unique || 0) >= 150 },
  { id: 'EH3', name: 'Mondfledermaus',    need: 'Kronen-Pass Geisternacht: Stufe 20', event: true, cond: () => false },
  { id: 'EH4', name: 'Hexenkessel',       need: 'Kronen-Pass Geisternacht: Premium-Stufe 5', event: true, cond: () => false },
  { id: 'EH5', name: 'Neonkatze',          need: 'Kronen-Pass Geisternacht: Stufe 25', event: true, cond: () => false },
  { id: 'EH6', name: 'Seelenlaterne',     need: 'Kronen-Pass Geisternacht: Premium-Stufe 12', event: true, cond: () => false, anim: 'video' },
  { id: 'EH7', name: 'Mitternachtshexe',  need: 'Kronen-Pass Geisternacht: Premium-Stufe 27', event: true, cond: () => false, anim: 'video' },
  { id: 'ESUP', name: 'Tüftel-Hamster', need: 'Nur als Dankeschön vom Entwickler-Team (Support)', event: true, cond: () => false, anim: 'video' },
  { id: 'EX1', name: 'Knochenwürfel', need: 'Kronen-Pass Casino-Strang: Stufe 3', event: true, cond: () => false, anim: 'video' },
  { id: 'EX2', name: 'Kürbis-Chip', need: 'Kronen-Pass Casino-Strang: Stufe 8', event: true, cond: () => false, anim: 'video' },
  { id: 'EX3', name: 'Skelett-Automat', need: 'Kronen-Pass Casino-Strang: Stufe 13', event: true, cond: () => false, anim: 'video' },
  { id: 'EX5', name: 'Highroller-Prestige', need: 'Kronen-Pass Casino-Strang: Stufe 20 (2,5 Mio Casino-XP) · auch als Prestige-Logo', event: true, cond: () => false, anim: 'video' },
  { id: 'EX4', name: 'Sensen-Jackpot', need: 'Kronen-Pass Casino-Strang: Stufe 18', event: true, cond: () => false, anim: 'video' },
  { id: 'EH1', name: 'Kürbiskrone',       need: 'Kronen-Pass Geisternacht: Stufe 30', event: true, cond: () => false },
  { id: 'EH2', name: 'Geisterkönig',      need: 'Kronen-Pass Geisternacht: Premium-Stufe 30', event: true, cond: () => false, anim: 'video' },
  { id: 'EK2', name: 'Goldenes Album',    need: 'Sammle alle Karten: jede Karte in jeder Fassung, Doppelte zählen nicht', cond: (u) => (u.collect_unique || 0) >= (u.collect_all || 295), anim: 'video' },
...
const TITLES = [
  ...
  { id: 'TS1', text: 'Vollbild-Jäger', style: 'legende', need: 'Hol 25 Vollbilder bei Triple Crown', cond: (u) => (u.slot_full || 0) >= 25, anim: 'video' },
  { id: 'TS2', text: 'Kronen-Zocker',  style: 'legende', need: 'Gewinne 250.000 Diamanten in einem Triple-Crown-Spiel', cond: (u) => (u.slot_best || 0) >= 250000, anim: 'video' },
  { id: 'TK1', text: 'Albumhüter',  style: 'legende', need: 'Sammle 250 verschiedene Karten, jede Fassung zählt einmal', cond: (u) => (u.collect_unique || 0) >= 250, anim: 'video' },
  { id: 'TH4', text: 'Neonnacht', style: 'legende', need: 'Kronen-Pass Geisternacht: Stufe 3', event: true, cond: () => false },
  { id: 'TH5', text: 'Seelenwächter', style: 'legende', need: 'Kronen-Pass Geisternacht: Premium-Stufe 3', event: true, cond: () => false, anim: 'video' },
  { id: 'TH6', text: 'Hexenzirkel', style: 'legende', need: 'Kronen-Pass Geisternacht: Premium-Stufe 23', event: true, cond: () => false, anim: 'video' },
  { id: 'TH2', text: 'Gruselfan', style: 'legende', need: 'Kronen-Pass Geisternacht: Stufe 10', event: true, cond: () => false },
  { id: 'TH3', text: 'Kürbiskopf', style: 'legende', need: 'Kronen-Pass Geisternacht: Premium-Stufe 15', event: true, cond: () => false },
  { id: 'TSUP', text: 'Supporter', style: 'legende', need: 'Nur als Dankeschön vom Entwickler-Team (Support)', event: true, cond: () => false, anim: 'video' },
  { id: 'TX1', text: 'Knochenzocker', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 5', event: true, cond: () => false, anim: 'video' },
  { id: 'TX2', text: 'Geistercroupier', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 10', event: true, cond: () => false, anim: 'video' },
  { id: 'TX3', text: 'Kürbis-Jackpot', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 15', event: true, cond: () => false, anim: 'video' },
  { id: 'TX4', text: 'Totenkopf-Highroller', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 20 (2,5 Mio Casino-XP)', event: true, cond: () => false, anim: 'video' },
  { id: 'TH1', text: 'Geisterfürst', style: 'legende', need: 'Kronen-Pass Geisternacht: Premium-Stufe 30', event: true, cond: () => false, anim: 'video' },
  { id: 'TK2', text: 'Komplettist', style: 'legende', need: 'Sammle alle Karten: jede Karte in jeder Fassung, Doppelte zählen nicht', cond: (u) => (u.collect_unique || 0) >= (u.collect_all || 295), anim: 'video' },
...
const CODES = { GRACE: 'Pink Pages und BookTok-Legende', GAMBLER: 'Casino-Paket: 3 animierte Titel, 3 Embleme, 3 Rahmen und 15.000 Diamanten', POKER: 'Poker-Startkapital: 10.000 Diamanten für die Pokertische', SLOT: 'Walzen-Startkapital: 10.000 Diamanten für Triple Crown' };
const CODE_DIAMONDS = { GAMBLER: 15000, POKER: 10000, SLOT: 10000 };
