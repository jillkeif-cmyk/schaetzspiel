...
const EMBLEMS = [
  ...
  { id: 'EP1', name: 'Kürbiskrone',       need: 'Kronen-Pass Geisternacht: Stufe 30', event: true, cond: () => false },
  { id: 'EP2', name: 'Geisterkönig',      need: 'Kronen-Pass Geisternacht: Premium-Stufe 30', event: true, cond: () => false, anim: 'video' },
...
const TITLES = [
  ...
  { id: 'TP1', text: 'Geisterfürst', style: 'legende', need: 'Kronen-Pass Geisternacht: Premium-Stufe 30', event: true, cond: () => false, anim: 'video' },
