...
const EMBLEMS = [
  ...
  { id: 'EC1', name: 'Knochenwürfel', need: 'Kronen-Pass Casino-Strang: Stufe 3', event: true, cond: () => false, anim: 'video' },
  { id: 'EC2', name: 'Kürbis-Chip', need: 'Kronen-Pass Casino-Strang: Stufe 8', event: true, cond: () => false, anim: 'video' },
  { id: 'EC3', name: 'Skelett-Automat', need: 'Kronen-Pass Casino-Strang: Stufe 13', event: true, cond: () => false, anim: 'video' },
  { id: 'EC5', name: 'Highroller-Prestige', need: 'Kronen-Pass Casino-Strang: Stufe 20 (2,5 Mio Casino-XP) · auch als Prestige-Logo', event: true, cond: () => false, anim: 'video' },
  { id: 'EC4', name: 'Sensen-Jackpot', need: 'Kronen-Pass Casino-Strang: Stufe 18', event: true, cond: () => false, anim: 'video' },
...
const TITLES = [
  ...
  { id: 'TC1', text: 'Knochenzocker', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 5', event: true, cond: () => false, anim: 'video' },
  { id: 'TC2', text: 'Geistercroupier', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 10', event: true, cond: () => false, anim: 'video' },
  { id: 'TC3', text: 'Kürbis-Jackpot', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 15', event: true, cond: () => false, anim: 'video' },
  { id: 'TC4', text: 'Totenkopf-Highroller', style: 'legende', need: 'Kronen-Pass Casino-Strang: Stufe 20 (2,5 Mio Casino-XP)', event: true, cond: () => false, anim: 'video' },
