...
const EMBLEMS = [
  ...
  { id: 'e14', name: 'Jäger',        need: 'Lande 100 mal im Doppel-Bereich (×2)',     cond: (u) => u.close >= 100 },
  ...
  { id: 'e22', name: 'Kleeblatt',     need: 'Lande 250 mal im Doppel-Bereich (×2)',    cond: (u) => u.close >= 250 },
  ...
  { id: 'ET3', name: 'Herr der Toon-Welt', need: 'Sammle alle 30 Toon-Welt-Karten',          cond: (u) => (u.toon_distinct || 0) >= 30 },
...
const TITLES = [
  ...
  { id: 't14', text: 'Tiefseetaucher', style: 'eis',    need: 'Lande 150 mal im Doppel-Bereich (×2)',  cond: (u) => u.close >= 150 },
  ...
  { id: 'TP1', text: 'Violetter Flush',  style: 'lila',    need: 'Gewinne 25 Pots beim Poker', cond: (u) => (u.poker_wins || 0) >= 25, anim: 'video' },
  { id: 'TP2', text: 'Asse in Flammen',  style: 'feuer',   need: 'Gewinne 20 Hände, in denen du All-in warst', cond: (u) => (u.poker_allin_wins || 0) >= 20, anim: 'video' },
  { id: 'TP3', text: 'König des Pokers', style: 'legende', need: 'Gewinne 800 Pots beim Poker', cond: (u) => (u.poker_wins || 0) >= 800, anim: 'video' },
  ...
  { id: 'TT3', text: 'Herrscher der Toon-Welt', style: 'legende', need: 'Sammle alle 30 Toon-Welt-Karten',          cond: (u) => (u.toon_distinct || 0) >= 30 },
...
const CODES = { GRACE: 'Pink Pages und BookTok-Legende', GAMBLER: 'Casino-Paket: 3 animierte Titel, 3 Embleme, 3 Rahmen und 15.000 Diamanten' };
const CODE_DIAMONDS = { GAMBLER: 15000 };
