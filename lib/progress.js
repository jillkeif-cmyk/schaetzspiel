...
const LABEL = { poker_minutes: 'Minuten am Pokertisch', poker_hands: 'Poker-Hände', poker_wins: 'gewonnene Pots', poker_best: 'Diamanten in einem Pot', poker_allin_wins: 'gewonnene All-ins', toon_distinct: 'Toon-Welt-Karten', casino_rounds: 'Casino-Runden', casino_wins: 'Casino-Siege', casino_best: 'Bester Casino-Gewinn', cards_total: 'Karten', cards_rare: 'Seltene Karten', cards_ext: 'Extended-Art-Karten', points: 'Punkte insgesamt', rank_points: 'Weltranglistenpunkte', wins: 'Siege', matches: 'Matches', exact: 'Punktlandungen', close: 'Doppelte (×2)', mc_right: 'Auswahlfragen richtig', answered: 'Fragen beantwortet', best_score: 'Punkte in einem Match', best_streak: 'Siege in Folge' };
