...
function applyMatch(u, r) {
  ...
  return { user: n, summary: { parts, gained, levelBefore: lvBefore.level, levelAfter: lvAfter.level, unlocked, canPrestige: prestigeStatus(n).can } };
}

module.exports = { MAX_LEVEL, MAX_PRESTIGE, CAP, PRESTIGE_NAMES, levelInfo, prestigeStatus, challengeView, applyMatch };
