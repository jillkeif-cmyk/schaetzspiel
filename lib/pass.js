...
const FREE = {
  ...
  21: { box: 'small' }, 22: { dia: 500 }, 23: { xp: 1500 }, 24: { spin: 3 }, 25: { pack: 'standard' },
...
const PREM = {
  ...
  11: { spin: 5 }, 12: { pack: 'ghost' }, 13: { dia: 1000 }, 14: { xp: 2000 }, 15: { pack: 'ghost', item: 'TH3', kind: 'title', name: 'Kürbiskopf' },
  ...
  26: { pack: 'toon' }, 27: { dia: 1000 }, 28: { xp: 3000 }, 29: { dia: 1000, spin: 5 },
...
module.exports = { setPerTier, perTier, BOXES, openBox, PREMIUM_PRICE, XP_PER_TIER, TIERS, BANK, SEASON, FREE, PREM, WEEK_TASKS, weekId, active, tierOf, bankOf, set, norm, view };
