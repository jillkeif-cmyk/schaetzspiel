...
Object.assign(FREE, { 5: { pack: 'standard' }, 10: { dia: 400, item: 'TH2', kind: 'title', name: 'Gruselfan' }, 15: { pack: 'standard' }, 20: { pack: 'premium', item: 'EH3', kind: 'emblem', name: 'Mondfledermaus' }, 25: { pack: 'standard' }, 30: { item: 'EH1', kind: 'emblem', name: 'Kürbiskrone' } });
Object.assign(PREM, {
  5: { dia: 500, pack: 'premium', item: 'EH4', kind: 'emblem', name: 'Hexenkessel' }, 10: { dia: 2000, pack: 'premium' }, 15: { dia: 500, pack: 'ghost', item: 'TH3', kind: 'title', name: 'Kürbiskopf' },
  20: { dia: 2000, item: 'fp1', kind: 'frame', name: 'Geisternacht' }, 25: { dia: 500, pack: 'ghost' },
  30: { dia: 5000, item: 'TH1', kind: 'title', name: 'Geisterfürst', item2: 'EH2', kind2: 'emblem', name2: 'Geisterkönig' },
});
