...
let XP_PER_TIER = 2500; // im Admin-Menü einstellbar (Einstellung pass_per_tier); 2.500 ≈ 60 Siege bis Stufe 30
const TIERS = 30;
...
const CASINO = {
  1: { dia: 2000 }, 2: { pack: 'gn' }, 3: { dia: 2000, item: 'EX1', kind: 'emblem', name: 'Knochenwürfel' }, 4: { pack: 'gn' },
  5: { spin: 3, item: 'TX1', kind: 'title', name: 'Knochenzocker' }, 6: { dia: 5000 }, 7: { pack: 'gn' }, 8: { pack: 'gn', item: 'EX2', kind: 'emblem', name: 'Kürbis-Chip' },
  9: { dia: 7500 }, 10: { pack: 'gn', item: 'TX2', kind: 'title', name: 'Geistercroupier' }, 11: { box: 'big' }, 12: { pack: 'gn', spin: 5 },
  13: { dia: 10000, item: 'EX3', kind: 'emblem', name: 'Skelett-Automat' }, 14: { pack: 'gn' }, 15: { dia: 15000, item: 'TX3', kind: 'title', name: 'Kürbis-Jackpot' },
  16: { box: 'big' }, 17: { pack: 'gn' }, 18: { pack: 'gn', item: 'EX4', kind: 'emblem', name: 'Sensen-Jackpot' }, 19: { dia: 25000 },
  20: { pack: 'disp_gn', item: 'TX4', kind: 'title', name: 'Totenkopf-Highroller', item2: 'EX5', kind2: 'emblem', name2: 'Highroller-Prestige' },
};
