...
module.exports = { setEpoch, epoch, setMode, state, unlockAt: () => UNLOCK, setPerTier, perTier, BOXES, openBox, PREMIUM_PRICE, XP_PER_TIER, TIERS, BANK, SEASON, FREE, PREM, WEEK_TASKS, weekId, active, tierOf, bankOf, set, norm, view };
