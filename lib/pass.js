...
const FREE = {
  1: { dia: 200 }, 2: { spin: 1 }, 3: { xp: 500, item: 'TH4', kind: 'title', name: 'Neonnacht' }, 4: { dia: 200 }, 5: { pack: 'standard' },
...
const PREM = {
  1: { dia: 1000 }, 2: { pack: 'premium' }, 3: { spin: 3, item: 'TH5', kind: 'title', name: 'Seelenwächter' }, 4: { dia: 1000 }, 5: { dia: 500, item: 'EH4', kind: 'emblem', name: 'Hexenkessel' },
  6: { box: 'big' }, 7: { pack: 'toon' }, 8: { dia: 1000 }, 9: { cxp: 5000 }, 10: { dia: 2500, pack: 'premium' },
  11: { spin: 5 }, 12: { pack: 'gn', item: 'EH6', kind: 'emblem', name: 'Seelenlaterne' }, 13: { dia: 1000 }, 14: { xp: 2000 }, 15: { pack: 'ghost', item: 'TH3', kind: 'title', name: 'Kürbiskopf' },
  16: { dia: 1000 }, 17: { box: 'big' }, 18: { pack: 'toon' }, 19: { dia: 1000 }, 20: { dia: 2500, item: 'fp1', kind: 'frame', name: 'Geisternacht' },
  21: { spin: 5 }, 22: { pack: 'gn' }, 23: { cxp: 10000, item: 'TH6', kind: 'title', name: 'Hexenzirkel' }, 24: { dia: 1000 }, 25: { box: 'big', pack: 'premium' },
